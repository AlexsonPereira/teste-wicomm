...
export const App = () => {
  return (
    <main>
        ...
        <section className="absolute top-[117px] inset-x-0 ">
          <div className="flex items-center flex-col">
            <div className="w-[412px] flex justify-between px-6 py-4 bg-white">
              <span className="text-2xl text-[#4F4F4F]">#SuperBazar</span>
              <p className="text-sm">até <span className="font-bold text-2xl text-[#CF215B]">50%OFF</span></p>
            </div>
            <img src={imagem2} alt="Imagem Sandalia"/>
            <button className="bg-[#CF215B] text-white font-normal py-[14px] px-[48px] relative bottom-6">Conferir</button>
          </div>
        </section>
        <div className="w-full h-[109px] bg-gradient2 absolute bottom-0 left-0"></div>
      </section>
      <section className="bg-[#F5F5F5] flex justify-center py-[32px]">
        <ul className="flex gap-[97px] text-[#4F4F4F]">
      ...
      <section>
        <p className="text-[#4F4F4F] text-2xl text-center mt-[72px] mb-[32px]">
          Compre por categoria
        </p>
        <ul className="flex gap-[36px] justify-center text-[#4F4F4F]">
      ...
      <section className="bg-[#F5F5F5] flex py-[32px] px-[155px] justify-between">
        <div className="">
          ...
          <div className="flex flex-col">
            <h3 className="text-[20px] text-[#4F4F4F] mb-[16px] mt-[56px]">Pra brilhar no verão</h3>
            ...
            <button className="bg-[#CF215B] text-white font-normal py-[14px] px-[24px] relative bottom-6 w-[158px] mt-[32px]">É a minha cara</button>
          </div>
        </div>
         <img src={mulhercarrinho} alt="mulher em um carrinho de compras"/>
      </section>
      <section>
        <p className="mt-[72px] text-center text-[24px] text-[#4F4F4F] mb-[24px]">Favoritos da Semana</p>
      ...
      <section className="bg-[#F5F5F5] pt-10 pb-[54px] flex gap-5 justify-center">
        <div className="w-fit">
          <p className="text-xl text-[#4F4F4F] mb-2">Rasteiras &  Birkens</p>
        ...
        <div className="w-fit">
          ...
          <div className="flex flex-col justify-center items-center">
            <p className="text-xl text-[#4F4F4F] mb-2 mt-6">Tênis</p>
            <p className="w-[250px] text-xs text-[#4F4F4F] mb-[38px]">Os tênis femininos se tornaram um item básico na moda e nos calçados do dia a dia.</p>
            <p className="flex items-center gap-4 text-[#4F4F4F]">Conferir <img src={arrow2} alt="Seta" /></p>
          </div>
        </div>
      </section>
      ...
      <section className="flex justify-center items-center py-[72px]">
        <div className="mr-[133px]">
          <h3 className="text-2xl text-[#4F4F4F]">Sobre a Sapatella</h3>
          <p className="w-[461px] text-[#4F4F4F]">
      ...
      <section className="bg-[#F5F5F5] flex items-center flex-col py-[35px]">
        <p className="text-xl text-[#4F4F4F]">Cadastre-se e ganhe <span className="text-[#CF215B] font-bold">R$20 OFF</span> na sua primeira compra!</p>
        <div className="flex gap-5 mt-[13px]">
          <input placeholder="Nome" className="w-[277px] h-10 bg-white py-[11px] px-[12px] focus:outline-none border-[1px] border-black placeholder:text-[#B0B0B0]" type="text" />
          <input placeholder="Email" className="w-[277px] h-10 bg-white py-[11px] px-[12px] focus:outline-none border-[1px] border-black placeholder:text-[#B0B0B0]" type="text" />
          <button className="bg-[#CF215B] text-white w-[178px]">Cadastrar</button>
        </div>
      </section>
      <Footer/>
    </main>
